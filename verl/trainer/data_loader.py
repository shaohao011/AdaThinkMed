...
def create_dataloader(config: DataConfig, tokenizer: PreTrainedTokenizer, processor: Optional[ProcessorMixin]) -> None:
    train_dataset = RLHFDataset(
        debug=config.debug,
        debug_num=config.debug_data_size,
    ...
    # if config.debug:
    #     train_dataset = train_dataset[:config.debug_data_size]
    ...
    print(len(train_dataset),train_batch_size)
    print("================")
    ...
    # if config.debug:
    #     val_dataset = val_dataset[:config.debug_data_size]
